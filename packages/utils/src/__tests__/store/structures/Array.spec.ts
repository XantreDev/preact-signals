...
describe("reactivity/reactive/Array", () => {
  ...
  it("Array identity methods should work if raw value contains reactive objects", () => {
    const raw = [] as any[];
    const obj = reactive({});
    raw.push(obj);
  ...
  it("Array identity methods should be reactive", () => {
    const obj = {};
  ...
  //   // read + write
  //   it("read + write mutating methods", () => {
  ...
  describe("Array subclasses", () => {
    ...
    it("calls correct mutation method on Array subclass", () => {
    ...
    it("calls correct identity-sensitive method on Array subclass", () => {
      const subArray = new SubArray(4, 5, 6);
      const observed = reactive(subArray);
      let index;
